...
public class PlayerConfig {
    ...
    public boolean autoContact;//是否开启断网自动重连
    ...
    private PlayerConfig(PlayerConfig origin) {
        ...
        this.autoContact = origin.autoContact;
    }
    ...
    public static class Builder {
         ...
         * 断网自动重连
         */
        public Builder enableAutoContact() {
            target.autoContact = true;
            return this;
        }
