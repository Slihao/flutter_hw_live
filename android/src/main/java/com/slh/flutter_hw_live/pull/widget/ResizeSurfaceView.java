package com.slh.flutter_hw_live.pull.widget;
...
//        LogUtils.d("@@@@", "onMeasure: width" + width + "    height:" + height);
        ...
        //如果设置了比例
        switch (screenType) {
            case WeVideoView.SCREEN_SCALE_ORIGINAL:
                width = mVideoWidth;
                height = mVideoHeight;
                break;
            case WeVideoView.SCREEN_SCALE_16_9:
                ...
                break;
            case WeVideoView.SCREEN_SCALE_4_3:
                if (height > width / 4 * 3) {
                    height = width / 4 * 3;
                } else {
                    width = height / 3 * 4;
                }
//                LogUtils.d("@@@@", "onMeasure 4:3 : width" + width + "    height:" + height);
                break;
            case WeVideoView.SCREEN_SCALE_MATCH_PARENT:
                width = widthMeasureSpec;
                height = heightMeasureSpec;
                break;
            case WeVideoView.SCREEN_SCALE_CENTER_CROP:
