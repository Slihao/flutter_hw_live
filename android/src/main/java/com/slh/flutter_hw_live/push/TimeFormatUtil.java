...
public class TimeFormatUtil {
    ...
    public static int formatString2Us(String timeStr) {
        int us;
        int hh = 0;
        int mm;
        int ss;
        if (timeStr.length() > 6) {
            ...
            mm = Integer.parseInt(timeStr.substring(3, 5));
            ss = Integer.parseInt(timeStr.substring(timeStr.lastIndexOf(":") + 1));
        } else {
            mm = Integer.parseInt(timeStr.substring(0, 2));
            ss = Integer.parseInt(timeStr.substring(timeStr.lastIndexOf(":") + 1));
        }
        us = (hh * 3600 ) + (mm * 360) + ss;
        return us;
    }
